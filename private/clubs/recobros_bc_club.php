...
if($conn)
{
      if(mysql_selectdb($namedb,$conn))
      {
        $sql = "SELECT clubs_SERVICE.id_club,clubs_SERVICE.name_club,clubs_SERVICE.id_carrier,clubs_SERVICE.route,".
          ...
          " WHERE clubs_CARRIER.id_carrier = $id_carrier and clubs_RECOBRO_AUTO.hour_session = '$hora' and clubs_SERVICE.`status` = 'enable' and clubs_RECOBRO_AUTO.last_exe <= '$fecha' and clubs_RECOBRO_AUTO.$str_day_field='1' and clubs_RECOBRO_AUTO.status = 'enable'";
          echo "$sql\n"; 
