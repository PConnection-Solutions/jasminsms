...
if($conn)
{
  ...
  echo $sql . "\n";
    ...
    echo $sql . "\n";
              ...
              " as dias_alta FROM clubs_MSISDN WHERE clubs_MSISDN.id_clubs = $id_club  AND clubs_MSISDN.state = 'enable' AND fecha_cobro <= DATE(CONVERT_TZ(NOW(), 'UTC', 'America/Tegucigalpa')) ORDER BY clubs_MSISDN.points DESC";
    echo $sql . "\n";
