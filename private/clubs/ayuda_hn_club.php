...
function precio($sc){
	if($sc == '7789' or $sc == '7788' or $sc == '7771' or $sc == '1185' or $sc == '1180' or $sc == '1181' or $sc == '7700' or $sc == '7787' or $sc == '7785'){
		return "$0.30";
	}else{
		return "$0.30";
	}
            ...
            if ($num_row > 0)
            {
                if ($num_row == 1)
                {
                    ...
                    else
                    {
                        ...
                        if($cliente_data['state'] == 'enable')
                        {
                            $club_name = strtoupper($clubs_data['name_club']);
                            $short_code_mo = $clubs_data['sc_mo'];
                            $msg = "Estas suscrito a $club_name. Costo x dia " . precio($short_code_mo)  . ". Para SALIR envia SALIR + $club_name al $short_code_mo. -PC";
                        }else
                        {
                ...
                else
                {
                    ...
                    $club_name = strtoupper($clubs_name);
                    $msg = "Estas suscrito a $club_name. Costo x dia " . precio($short_code_mo)  . ". Para SALIR envia SALIR + CLUB al $short_code_mo. -PC";
