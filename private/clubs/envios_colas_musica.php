...
$cmd = "pkill -f cobros_bc_club_recobro_musica_semanal_V2.php";
...
while ($fila = mysqli_fetch_assoc($result)) {
	...
	if (count($datos) === 50000) {
		...
		$cmd = "php -q /opt/lampp/htdocs/private/clubs/cobros_bc_club_recobro_musica_semanal_V2.php id_carrier=1 prioridad=2 inicio=$limiteInicio final=$limiteFinal >> /opt/lampp/htdocs/private/clubs/cobros_bc_club_recobro_musica_semanal_V2.log &";
		echo $cmd . "\n";
		shell_exec($cmd);
		sleep(2);
		unset($datos);
