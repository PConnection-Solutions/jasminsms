<?php
  ...
  $channel->queue_declare('CLARO_SVC', false, true, false, false);
  echo ' [*] Esperando los mensajes del deliverNotification de Claro SVC. Oprima CTRL+C para salir', "\n";
  ...
  $channel->basic_consume('CLARO_SVC', '', false, false, false, false, $callback);
