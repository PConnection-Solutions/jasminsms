...
if($conn)
{
	...
	echo $sql . "\n";
		...
		echo $sql . "\n";
              ...
              " as dias_alta FROM clubs_MSISDN WHERE clubs_MSISDN.id_clubs = $id_club  AND clubs_MSISDN.state = 'enable' AND clubs_MSISDN.msisdn IN (SELECT clubs_ENVIOS_DIARIOS2.msisdn FROM clubs_ENVIOS_DIARIOS2) ORDER BY clubs_MSISDN.points DESC";
		echo $sql . "\n";
