<?php
  ...
  echo ' [*] Esperando los mensajes del deliverNotification de Claro SV. Oprima CTRL+C para salir', "\n";
  ...
  $callback = function($msg) use ($conn) 
  {
	...
	if($from == '7788')
        {
            $url2 = "http://localhost/comunout/desafio/incripcion_juegasv.php";
  ...
  $channel->basic_consume('CLARO_SV', '', false, false, false, false, $callback);
