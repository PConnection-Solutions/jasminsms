...
$connection = new AMQPConnection('localhost', 5672, 'guest', 'guest');
  ...
  $channel->queue_declare('TigoNACKAlta', false, true, false, false);
...
$callback = function($msg) use ($conn, $namedb)
{
	...
	if (isset($DATA['penvio'])) {
        ...
        error_log("$source - $destination - $meta_mod"."\n", 3, "dlr_escalonado_temp.log");
        sleep(30);
...
$channel->basic_qos(null, 1, null);
  $channel->basic_consume('TigoNACKAlta', '', false, false, false, false, $callback);
