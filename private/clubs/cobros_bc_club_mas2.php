...
if($conn)
{
  ...
  echo $sql . "\n";
    ...
    echo $sql . "\n";
              ...
              " as dias_alta FROM clubs_MSISDN WHERE clubs_MSISDN.id_clubs = $id_club  AND clubs_MSISDN.state = 'enable' AND clubs_MSISDN.msisdn NOT IN (SELECT DISTINCT(clubs_ENVIOS_DIARIOS.msisdn) FROM clubs_ENVIOS_DIARIOS_1 WHERE id_clubs = $id_club) GROUP BY msisdn ORDER BY clubs_MSISDN.points DESC";
