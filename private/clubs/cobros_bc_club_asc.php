	...
	echo $sql . "\n";
		...
		echo $sql . "\n";
	      ...
	      log_envios($id_club, date("Y-m-d H:i:s"), $uuid, 0, date("Y-m-d H:i:s"));
              ...
              " as dias_alta FROM clubs_MSISDN WHERE clubs_MSISDN.id_clubs = $id_club  AND clubs_MSISDN.state = 'enable' AND clubs_MSISDN.msisdn IN (SELECT clubs_ENVIOS_DIARIOS1.msisdn FROM clubs_ENVIOS_DIARIOS1) ORDER BY clubs_MSISDN.points DESC";
		echo $sql . "\n";
