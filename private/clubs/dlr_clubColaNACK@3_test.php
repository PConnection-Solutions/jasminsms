...
$connection = new AMQPConnection('10.7.48.13', 5672, 'admin', 'Admin2023$');

  $channel = $connection->channel();

  $channel->queue_declare('TigoNACK@3', false, true, false, false);
...
$channel->basic_qos(null, 1, null);
  $channel->basic_consume('TigoNACK@3', '', false, false, false, false, $callback);
