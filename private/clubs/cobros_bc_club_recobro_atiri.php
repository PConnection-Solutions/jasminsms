    ...
    echo $sql . "\n";
	      ...
	      $registros = mysql_num_rows($clientes);
              ...
              while(($row_cliente = mysql_fetch_array($clientes)) && ($contenido_data))
              {
                  ...
                  $fecha_cobro = $row_cliente['fecha_cobro'];
                  ...
                  else
                  {
                      ...
                      {
                          if ($fecha_cobro < date("Y-m-d")) {
                            $id_delivery = $response_paid->enviar($msisdn,$row_servicio['sc_cobro'],$contenido_text,true);
                            echo "$msisdn,".$row_servicio['sc_cobro'].",$contenido_text,true\n";
                          } else {
                            $id_delivery = $response_free->enviar($msisdn,$row_servicio['sc_cobro1'],$contenido_text,false);
                            echo "$msisdn,".$row_servicio['sc_cobro1'].",$contenido_text,false\n";
                          }
                      }
