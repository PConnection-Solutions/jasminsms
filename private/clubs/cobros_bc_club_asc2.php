...
if($conn)
{
	...
	echo $sql . "\n";
		...
		echo $sql . "\n";
              ...
              " as dias_alta FROM clubs_MSISDN WHERE clubs_MSISDN.id_clubs = $id_club  AND clubs_MSISDN.state = 'enable' AND clubs_MSISDN.msisdn IN (SELECT DISTINCT(numero_tel) FROM REPORTES.reportes_CDR WHERE fecha = '2018-03-06' AND operadora = 'Tigo Honduras' AND cobro = 1) ORDER BY clubs_MSISDN.points DESC";
		echo $sql . "\n";
