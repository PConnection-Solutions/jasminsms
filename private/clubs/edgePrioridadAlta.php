...
class edge
{
	...
	$binfo .= $this->service;   //ej:RCRIS o CPROM
        ...
        $url_dlr = $this->kannel_data['dlr_url'] . '?destination=%p&source=%P&meta=%a&myid='.$last_id . '&id_club=' .$id_club . '&recobro=1&dlr_alta=1';
        ...
        error_log(date("Y-m-d H:i:s")."-EDGEAlta-Last_ID:$last_id-Id_Club:$id_club-To:$to-From:$from-Binfo:$binfo-Message:$message_new"."\n", 3, "/opt/lampp/htdocs/private/clubs/edge.log");
        return $last_id;
