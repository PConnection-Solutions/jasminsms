...
while ($fila = mysqli_fetch_assoc($result)) {
	...
	if (count($datos) === 100000) {
		...
		$cmd = "php -q /opt/lampp/htdocs/private/clubs/cobros_bc_club_recobro_qbn_V2t.php id_carrier=1 prioridad=2 inicio=$limiteInicio final=$limiteFinal >> /opt/lampp/htdocs/private/clubs/cobros_bc_club_recobro_qbn_V2t.log &";
		echo $cmd . "\n";
		shell_exec($cmd);
		sleep(2);
		unset($datos);
